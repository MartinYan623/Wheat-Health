import pandas as pd
encoding='UTF-8'
data=pd.read_csv('data/new_宝妈营得分.csv',usecols=[0,2,6,7,8,9,12])
...
dataframe.to_csv('/Users/martin_yan/Desktop/new_babymother_data.csv', index=False, encoding="utf_8_sig", columns=columns)
