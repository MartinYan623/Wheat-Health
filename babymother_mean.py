import pandas as pd
encoding='UTF-8'
data=pd.read_csv('/Users/martin_yan/Desktop/babymother_data.csv')
...
for i in range(len(data)):
    ...
    if username[i]==False:
        ...
        dataframe2.to_csv('/Users/martin_yan/Desktop/mean_babymother_data.csv', index=False, encoding="utf_8_sig",
