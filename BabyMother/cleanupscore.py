...
data=pd.read_csv('/Users/martin_yan/Desktop/babymother_data5.22-6.11.csv',usecols=['用户编号','姓名','记录日期','总得分'])
#info=pd.read_csv('../data/宝妈用户减重表5.22-6.4.csv',usecols=['姓名'])
info=pd.read_csv('/Users/martin_yan/Desktop/mean_babymother_data5.22-6.11.csv',usecols=['姓名','平均得分'])
...
for i in range(len(data)):
    ...
    if username[i]==False:
        ...
        dataframe = pd.DataFrame({'用户编号':[id],'姓名':[name],'5.22':[score[0]],'5.23':[score[1]],'5.24':[score[2]],'5.25':[score[3]],'5.26':[score[4]],
                                  ...
                                  '6.1': [score[10]],'6.2':[score[11]],'6.3':[score[12]],'6.4':[score[13]],'6.5':[score[14]],'6.6':[score[15]],
                                  '6.7': [score[16]],'6.8':[score[17]],'6.9':[score[18]],'6.10':[score[19]],'6.11':[score[20]],
                                  '平均得分':[mean]})

        columns = ['用户编号', '姓名', '5.22','5.23','5.24','5.25','5.26','5.27','5.28','5.29','5.30','6.1','6.2','6.3','6.4','6.5',
                   '6.6','6.7','6.8','6.9','6.10','6.11','平均得分']
