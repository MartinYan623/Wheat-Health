...
columns= ['用户编号', '姓名', '年龄','BMI','记录天数','完整记录天数','水果实际摄入平均量', '水果摄入量平均分', '蔬菜实际摄入平均量', '蔬菜摄入量平均分', '全谷类实际摄入平均量', '全谷类摄入量平均分',
                    ...
                    '添加糖实际摄入平均量', '添加糖摄入量平均分', '轻食日热量平均对比值','普通日热量平均对比值','总热量摄入量平均分', '三大营养素实际摄入平均量', '三大营养素组成平均分', '饮酒实际摄入平均量',
                    '饮酒（酒精量，全天标准）平均分', '饮水平均量', '饮水量平均分','平均得分','初始体重值','减重值','减重百分比','助理名称']
data.to_csv('/Users/martin_yan/Desktop/mean_babymother_data5.22-6.1823424324.csv',index=False, encoding="utf_8_sig",columns=columns)
