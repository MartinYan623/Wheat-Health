...
#data=data[(True-data['日期'].isin(['2018/6/10 0:00','2018/6/11 0:00']))]
#data=data[(True-data['日期'].isin(['2018/6/2 0:00','2018/6/3 0:00','2018/6/5 0:00']))]
#print(data)
...
dataframe=pd.DataFrame({'用户编号':id,'姓名':name,'实际记录天数':day,'减重值':reduce})
columns=['用户编号','姓名','实际记录天数','减重值']
print(dataframe)
dataframe.to_csv('/Users/martin_yan/Desktop/第三周累积减重值情况.csv', index=False, encoding="utf_8_sig",columns=columns)