import pandas as pd
encoding='UTF-8'
data=pd.read_csv('data/宝妈营数据5.22-5.29.csv',usecols=[0,2,6,7,8,9,12])
data2=pd.read_csv('data/宝妈营数据5.30-6.4.csv',usecols=[0,2,6,7,8,9,12])
...
dataframe.to_csv('/Users/martin_yan/Desktop/babymother_data5.22-6.4.csv', index=False, encoding="utf_8_sig", columns=columns)
